...
function Form() {
  ...
  const [orderValues, setOrderValues] = useState(orderToppings);
  const [orderErrors, setOrderErrors] = useState(missingInformation);
  const [newOrder, setNewOrder] = useState(orderToppings);
    ...
    <form onSubmit={onSubmit}>
      <div className="form">
        ...
        <div className="add-to">
          <button id="submit-btn" onClick={(evt) => evt.preventDefault}>
            Add to order
          </button>
        </div>
